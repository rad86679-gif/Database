...
console.log("✅ Proteksi Anti Bypass Active ./RozzyOfficial");
  ...
  if (!validTokens?.includes(BOT_TOKEN)) {
    ...
    console.log(chalk.bold.red("TOKEN ANDA TIDAK TERDAFTAR DI DATA BASE - BUY AKSES DI @Xavatrz !!!"));
    console.log(chalk.red("═══════════════════════════════════════════"));
    process.exit(1);
  }
...
`)
  ...
  console.log(
    chalk.bold.green(`
🔱 TRISHULA TRIGER VERSION 1.0 GEN 1 🦖
`)
  );
}
...
This Is Pemilik : @Xavatrz
</blockquote>`;

    const mainKeyboard = [
      [
        { text: "Author Demonic", url: "https://t.me/Xavatrz" },
      ...
      [
        { text: "Channel Xava", url: "https://t.me/" },
      ],
    ];
    ...
    await ctx.replyWithAudio(
      { url: "https://files.catbox.moe/spadk5.mp3" },
      {
        ...
        title: "TRISHULA Audio",
        performer: "TRISHULA TRIGER"
      }
    );
...
bot.command("TesFunc", checkWhatsAppConnection, checkPremium, async (ctx) => {
    try {
      ...
      const processMsg = await ctx.telegram.sendPhoto(
        ...
        { url: thumbnailUrl },
        {
          caption: `<blockquote><pre>─━━─━━⧼ 𝗧𝗥𝗜𝗦𝗛𝗨𝗟𝗔 𝗧𝗥𝗜𝗚𝗘𝗥 ⧽─━━─━━</pre></blockquote>
⌑ Target: ${q}
...
⌑ Status: Process`,
      ...
      const finalText = `<blockquote><pre>─━━─━━⧼ 𝗧𝗥𝗜𝗦𝗛𝗨𝗟𝗔 𝗧𝗥𝗜𝗚𝗘𝗥 ⧽─━━─━━</pre></blockquote>
⌑ Target: ${q}
⌑ Type: Unknown Function
⌑ Status: Success`
      try {
